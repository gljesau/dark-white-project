  ...
  return (
    <div className='mx-auto bg-white dark:bg-mainBlue'>
        ...
        <div className='container mx-auto flex flex-row justify-between mt-[48px] pb-[30px]'>
            <div className='border border-lightGray dark:border dark:bg-white bg-white w-[405px] h-[535px] '>
                <img className="w-full h-[270px]" src={news1} alt="" />
            ...
            <div className='border border-lightGray dark:bg-white bg-white w-[405px] h-[535px] '>
               <img className="w-full h-[270px]" src={news2} alt="" /> 
               <div className='flex gap-10 pl-5 pt-5'>
                <p className='text-lightGray'>September 9, 2020</p>
                <p className='text-lightGray'>Posted By Admin</p>
                </div>
            ...
            <div className='border border-lightGray dark:bg-white bg-white w-[405px] h-[535px] '>
                <img className="w-full h-[270px]"src={news3} alt="" />
              <div>
                <div className='flex gap-10 pl-5 pt-5'>
                <p className='text-lightGray'>September 9, 2020</p>
                <p className='text-lightGray'>Posted By Admin</p>
